...
class CafeController {
    ...
    private val shelters = Utilities.getAllShelter()
    private val shelterToCat = mutableMapOf<Shelter, MutableSet<Cat>>()

    init {
        shelterToCat[shelters.first()] = Utilities.fillShelterWith(6)
        shelterToCat[shelters.last()] = Utilities.fillShelterWith(4)
    }
